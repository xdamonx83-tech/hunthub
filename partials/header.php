...
?>
  ...
  <title><?= htmlspecialchars($title ?? 'HTDA – Login') ?></title>

  <!-- absolut, nie relativ -->
  <link rel="icon" href="<?= $APP_BASE ?>/assets/images/icons/favicon.ico" type="image/x-icon">
  <link rel="stylesheet" href="<?= $APP_BASE ?>/assets/styles/app.css">
  <script defer src="<?= $APP_BASE ?>/assets/js/app.js"></script>
</head>
<body>  <!-- ← fehlte in deinem Snippet -->
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
                                <img src="<?= $APP_BASE ?>/assets/images/users/avatar1.png" alt="avatar">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
                                <img src="<?= $APP_BASE ?>/assets/images/users/avatar2.png" alt="avatar">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
                                <img src="<?= $APP_BASE ?>/assets/images/users/avatar3.png" alt="avatar">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
                                <img src="<?= $APP_BASE ?>/assets/images/users/avatar4.png" alt="avatar">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
            ...
            <div class="flex flex-col items-center gap-16p rounded-full w-fit p-2">
                <div class="swiper infinity-slide-vertical messenger-carousel max-h-[136px] w-full">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
                                <img src="<?= $APP_BASE ?>/assets/images/users/avatar5.png" alt="avatar">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
                                <img src="<?= $APP_BASE ?>/assets/images/users/avatar6.png" alt="avatar">
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="chat.html" class="avatar size-60p">
